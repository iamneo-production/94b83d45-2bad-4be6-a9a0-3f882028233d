            ...
            <aside class="top-0 left-0 w-64 h-screen hidden md:block" aria-label="Sidebar">
                <div class="h-full px-3 py-4 bg-gray-50">
                    <ul class="space-y-2 font-medium">
                        <li key={0}>
                            <button onClick={() => setValue('lessonForm')} class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-400">
                                <MdPlayLesson class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900" />
                                <span class="ml-3">Add Lesson</span>
                            </button>
                        </li>
                        <li key={1}>
                            <button onClick={() => setValue('Quizzes')} class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-400">
                                <MdQuiz class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900"/>
                                <span class="ml-3 whitespace-nowrap">Add Quizzes</span>
                            </button>
                        </li>
                        <li key={2}>
                            <button onClick={() => setValue('Assignments')} class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-400">
                                ...
                                <span class="ml-3 whitespace-nowrap">Add Assignments</span>
                            </button>
                        </li>
                    </ul>
                </div>
