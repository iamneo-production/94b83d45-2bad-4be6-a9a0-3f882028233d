...
const SettingDetails = ({ profile }) => {

    const [editing, setEditing] = useState(false);
    const [editedProfile, setEditedProfile] = useState(profile);
    // const [editedPassword, setEditatedPassword] = useState(profile);
    ...
    const handleInputChange = (event) => {
        ...
        // if (setEditatedPassword) {
        //     setEditatedPassword((prevProfile) => ({
        //         ...prevProfile,
        //         [name]: value,
        //     }));
        // }
